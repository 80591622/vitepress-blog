import{_ as s,c as n,o as a,a5 as l}from"./chunks/framework.BQQWXjGs.js";const m=JSON.parse('{"title":"css的模块化","description":"","frontmatter":{},"headers":[],"relativePath":"workspace/Css/cssModules.md","filePath":"workspace/Css/cssModules.md","lastUpdated":1714231776000}'),p={name:"workspace/Css/cssModules.md"},e=l(`<h1 id="css的模块化" tabindex="-1">css的模块化 <a class="header-anchor" href="#css的模块化" aria-label="Permalink to &quot;css的模块化&quot;">​</a></h1><p><code>1</code>. 关于less使用建议</p><pre><code>1、过渡的嵌套会导致很多问题发生，使代码变得更复杂，而且太过依赖于HTML结构，这样后面要覆盖样式需要依赖于&quot;!important&quot;，而这种方式又是我们尽量避免使用的一种
