...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__scopeId", "data-v-f87ff6e4"]]);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__scopeId", "data-v-935f8a84"]]);
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["__scopeId", "data-v-7e05ebdb"]]);
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-09de1c0f"]]);
...
const VPHomeContent = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["__scopeId", "data-v-82d4af08"]]);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["__scopeId", "data-v-267dd0ed"]]);
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-d1f28634"]]);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-d0bd9dde"]]);
const _sfc_main$z = /* @__PURE__ */ defineComponent({
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BRHx_7CW.js"));
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-ccf7ddec"]]);
const _sfc_main$p = /* @__PURE__ */ defineComponent({
...
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-2d7af913"]]);
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-ff6087d4"]]);
const _sfc_main$k = /* @__PURE__ */ defineComponent({
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-cc5739dd"]]);
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-b8d55f3b"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "VPSidebar",
  __ssrInlineRender: true,
  props: {
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-575e6a36"]]);
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-0f60ec36"]]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
...
const Layout$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-5d98c3a5"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (weatherData.adCode.city && weatherData.weather.weather) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "weather" }, _attrs))}><span>${ssrInterpolate(weatherData.adCode.city)} </span><span>${ssrInterpolate(weatherData.weather.weather)} </span><span>${ssrInterpolate(weatherData.weather.temperature)}℃</span><span class="sm-hidden">  ${ssrInterpolate(((_a = weatherData.weather.winddirection) == null ? void 0 : _a.endsWith("风")) ? weatherData.weather.winddirection : weatherData.weather.winddirection + "风")}  </span><span class="sm-hidden">${ssrInterpolate(weatherData.weather.windpower)}</span></div>`);
      } else {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "weather" }, _attrs))}><span>天气数据获取失败</span></div>`);
      }
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/Weather.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "hitokoto cards" }, _attrs))} data-v-42da1a3e><div class="content" data-v-42da1a3e><span class="text" data-v-42da1a3e>${ssrInterpolate(hitokotoData.text)}</span><span class="from" data-v-42da1a3e>-「 ${ssrInterpolate(hitokotoData.from)} 」</span></div></div>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/Hitokoto.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const Hitokoto = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-42da1a3e"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      links.forEach((link2) => {
        link2.addEventListener("click", function(event) {
          ...
          navbars.forEach((navbar2) => {
            navbar2.style.backdropFilter = "none";
            navbar2.style.backgroundColor = "#ffffff";
          });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page VPContent is-home" }, _attrs))} data-v-36bc15a1><div class="left" data-v-36bc15a1>`);
      _push(ssrRenderComponent(Hitokoto, null, null, _parent));
      _push(`</div><div class="right cards" data-v-36bc15a1><div class="time" data-v-36bc15a1><div class="date" data-v-36bc15a1><span data-v-36bc15a1>${ssrInterpolate(currentTime.value.year)} 年 </span><span data-v-36bc15a1>${ssrInterpolate(currentTime.value.month)} 月 </span><span data-v-36bc15a1>${ssrInterpolate(currentTime.value.day)} 日 </span><span class="sm-hidden" data-v-36bc15a1>${ssrInterpolate(currentTime.value.weekday)}</span></div><div class="text" data-v-36bc15a1><span data-v-36bc15a1>${ssrInterpolate(currentTime.value.hour)}:${ssrInterpolate(currentTime.value.minute)}:${ssrInterpolate(currentTime.value.second)}</span></div></div>`);
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-36bc15a1"]]);
const RawTheme = {
  extends: theme,
  Layout: () => {
