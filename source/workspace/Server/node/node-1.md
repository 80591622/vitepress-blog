...
tags:
  - node
lastUpdated: "2021-10-16T02:29:09.865Z"
---
...
**\_\_filename** 全局值，当前文件绝对路径 module.filename === **filename 等价 <br/>
\*\***dirname** 全局值，当前文件夹绝对路径。等效于path.resolve(\_\_filename, '..')<br/>
