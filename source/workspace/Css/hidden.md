---
date: "2023-05-14 16:09:35"
title: hidden
categories:
  - Css
tags:
  - Css
lastUpdated: "2023-06-30T16:09:35.014Z"
---
...
//css .transition-display{ display: none; transition:display 2s; } .transition-display:hover{ display: block; }
```
...
//css .transition-visibility{ visibility: hidden; transition: visibility 2s; } .transition-visibility:hover{ visibility:
visible; }
```
...
```html
// css .transition-visibility{ visibility: visible; transition: visibility 1s; } .transition-visibility:hover{
visibility: hidden; }
```
...
```html
.undisplay.blue { width: 200px; height: 200px; background: blue; } .undisplay.yellow { width: 100px; height: 100px;
background: yellow; opacity: 0; //增加display display: none; transition: 1s } .undisplay.blue:hover .yellow { opacity:
1; //增加display display: block; }
```
