...
| `mv`                                      | 修改文件名、移动文件，如 `mv index.html .bash_profile`                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `cat`                                     | 查看内容                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `sudo vim /etc/hosts`                     | 修改 hosts                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ssh -p 2289 root@182.92.117.162`         | 登录 SSH                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `chattr +i .user.ini`                     | 恢复文件不可更动属性                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `chmod -R 777 pet_07`                     | 赋权限                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| chmod 参数                                | r：可读；w：可写；x：可执行<br/><br/>-rw------- (600) — 只有属主有读写权限<br/>-rw-r--r-- (644) — 只有属主有读写权限；属组和其他用户只有读权限<br/>-rwx------ (700) — 只有属主有读、写、执行权限<br/>**-rwxr-xr-x (755) — 属主有读、写、执行权限；其他用户组只有读、执行权限**<br/>-rwx--x--x (711) — 属主有读、写、执行权限；属组和其他用户只有执行权限<br/>-rw-rw-rw- (666) — 所有用户都有读、写权限（不推荐）<br/>-rwxrwxrwx (777) — 所有用户都有读、写、执行权限（更不推荐） |
| `sudo chown -R $(whoami) /path`           | 更改某个目录或文件的用户名和用户组                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `yarn version --new-version 1.0.0`        | 更改版本号                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `curl http://www.wkdevhub.cn:8000/banner` | HTTP 命令行工具                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `ping www.wkdevhub.cn`                    | ping                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `kill -9 PID`                             | 杀死进程                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `npx browser-sync start -s . -f .`        | 静态页面动态刷新                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `browser-sync start --server --files .`   | 静态页面动态刷新                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `rm -rf node_modules/.cache/babel-loader` | 清理 umi 缓存                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `nginx -s reload`                         | 重启 nginx                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `tar -czvf dist.tar.gz dist`              | 压缩 dist                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `tar -xzvf dist.tar.gz`                   | 解压                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| tar 参数                                  | -c：建立压缩档案；-x：解压；-z：gzip；-v：显示过程；-r：向归档末尾追加；-f：指定档案名（须为最后一个参数）                                                                                                                                                                                                                                                                                                                                                                       |
| `find / -name jenkins`                    | 查看安装目录                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `sed -i '' "s/666/777/g" config`          | 将文字 666 替换为 777                                                                                                                                                                                                                                                                                                                                                                                                                                                            |

**看一共写了多少代码**

```bash
find . \( -name "*.vue" -o -name "*.jsx" -o -name "*.tsx" -o -name "*.css" -o -name "*.less" -o -name "*.scss" -o -name "*.js" -o -name "*.ts" \) -print | xargs wc -l
```
