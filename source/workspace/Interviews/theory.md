---
date: "2020-07-19 17:36:54"
title: theory
categories:
  - Interviews
tags:
  - Interviews
lastUpdated: "2020-07-28T17:36:54.245Z"
---
...
1.使用click,解决300ms延迟问题 (解决了300毫秒延迟问题即解决了点透问题)<br/> 2.给上面元素加preventDefault()<br/>
...
3.使用一个(透明)遮罩层，屏蔽所有事件，然后400ms(对于IOS来说是个理想值)后自动隐藏<br/> 4.下层避开click事件，如a链接改为span等标签，使用js跳转页面（通过一个变量，只有在touchend触发时，才实现跳转）<br/>
